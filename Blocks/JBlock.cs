...
namespace TetrisGame.Blocks
{
    public class JBlock : Block
    {
        ...
        {
            new ElementPosition[] {new(0,0), new(1,0), new(1,1), new(1,2)},
            new ElementPosition[] {new(0,1), new(0,2),new(1,1), new(2,1)},
            new ElementPosition[]{new(1,0), new(1,1), new(1,2),new(2,2)},
            new ElementPosition[]{new(0,1), new(1,1), new(2,0), new(2,1)}
        };
